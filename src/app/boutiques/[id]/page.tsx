  ...
  return (
    <div>
      ...
      <div className="container-faso-wide">
        ...
        <Reveal
          y={20}
          className="relative -mt-16 flex flex-col gap-5 overflow-hidden rounded-4xl border border-clay-100 bg-white p-6 shadow-premium-lg md:-mt-20 md:flex-row md:items-end md:p-8"
        >
          <GrainTexture className="text-ink" opacity={0.03} />
          {shop.logo_url && (
        ...
        <Reveal className="mx-auto mt-12 max-w-3xl">
          <h2 className="text-display-3 font-bold text-ink">À propos</h2>
        ...
        <section className="mt-14">
          <Reveal>
            <h2 className="text-display-3 font-bold text-ink">Nos produits</h2>
          </Reveal>
          {shop.products.length > 0 ? (
            ...
            <EmptyState
              className="mt-6"
              icon={Package}
              title="Aucun produit publié pour l'instant"
              description="Cette boutique n'a pas encore publié de produit — revenez bientôt."
            />
          )}
        </section>
        ...
        {shop.gallery.length > 0 && (
          <section className="mt-14">
            <Reveal>
              <h2 className="text-display-3 font-bold text-ink">En images</h2>
            </Reveal>
            <div className="mt-6">
        ...
        <section className="mt-14">
          <Reveal>
            <h2 className="text-display-3 font-bold text-ink">Avis clients</h2>
        ...
        <section className="mt-16 mb-28 md:mb-16">
          <Reveal className="relative flex flex-col items-center gap-4 overflow-hidden rounded-4xl bg-ink p-8 text-center text-white shadow-premium-lg md:p-12">
            <GrainTexture className="text-white" opacity={0.04} />
            <div className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-faso-gradient opacity-30 blur-3xl" />
            <span className="accent-line" />
            <h2 className="relative font-editorial text-display-3 font-semibold md:text-display-2">
